...
public class DiarySearchUI {
  ...
  public void searchDiaryByTitle(Scanner input) {
    ...
    List<DiaryEntry> diaryEntries =
        RegisterHandler.getDiaryRegister().getDiaryEntriesByTitle(title);
  ...
  public void searchDiaryByDate(Scanner input) {
    System.out.println(
        "What's the date of the entry(ies) you're trying to search for (Format: YYYY-MM-DD)?");
  ...
  public void searchDiaryBetweenPeriod(Scanner input) {
    System.out.println(
        "What's the start date of the period you're trying to search for (Format: YYYY-MM-DD)?");
    LocalDate startDate = UtilityManager.ensureValidDate(input);
    System.out.println(
        "What's the end date of the period you're trying to search for (Format: YYYY-MM-DD)?");
    ...
    List<DiaryEntry> diaryEntries =
        RegisterHandler.getDiaryRegister().getDiaryEntriesBetweenPeriod(startDate, endDate);
    DiaryHelper.performSearch(diaryEntries);
  }
  ...
  public void searchDiaryByAuthor(Scanner input) {
    ...
    List<DiaryEntry> diaryEntries =
        RegisterHandler.getDiaryRegister().getDiaryEntriesByAuthor(author);
    DiaryHelper.performSearch(diaryEntries);
  }
  ...
  public void searchDiaryByPrompt(Scanner input) {
    ...
    // Search for diary entries with the given prompt and print them if any are found.
    List<DiaryEntry> diaryEntries =
        RegisterHandler.getDiaryRegister().getDiaryEntriesByPrompt(prompt);
    DiaryHelper.performSearch(diaryEntries);
  }
  ...
  public void searchDiaryByLabel(Scanner input) {
    ...
    List<DiaryEntry> diaryEntries =
        RegisterHandler.getDiaryRegister().getDiaryEntriesByLabel(label);
    DiaryHelper.performSearch(diaryEntries);
  }
