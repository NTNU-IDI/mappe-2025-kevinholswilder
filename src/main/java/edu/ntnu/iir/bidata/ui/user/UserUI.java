 ...
 *     Additionally, this class works together with the {@link UserService} class to perform the actual login and registration.
 * </p>
 *
...
public class UserUI {
    ...
    /**
     * Prompts the user to enter a username, name and surname and registers them if the username does not exist.
     *
     * @param input a {@link Scanner} object to read user input.
     */
